  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 left-1/2 transform -translate-x-1/2 px-4 py-2 z-30 rounded-full text-sm bg-[#fde6ea] border border-[#ed354f] text-[#ed354f] font-medium shadow-lg border transition-shadow duration-300 hover:shadow-[#ed354f]/40"
      >
        Carte
      </button>
