  ...
  return (
    <div className="fixed inset-0 overflow-hidden z-0">
      {orderedSteps.length > 0 && (
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20 mt-12 bg-white/80 backdrop-blur-sm border border-gray-200 shadow-xl rounded-xl p-4 w-[90%] max-w-md">
      ...
      {orderedSteps.length > 0 && (
        <a
          ...
          className="fixed right-4 w-12 h-12 bg-white/80 backdrop-blur-sm text-black rounded-full shadow-lg flex items-center justify-center"
